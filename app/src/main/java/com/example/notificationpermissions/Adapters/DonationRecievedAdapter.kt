...
class DonationRecievedAdapter(
    private val context: Context, private val transaction: List<Transaction>
) : RecyclerView.Adapter<DonationRecievedAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) :
        ...
        fun bindPost(transaction: Transaction) {
            ...
            try {
                ...
                val postBy = JSONObject(json.getString("post_by"))
                val donor = postBy.getString("user_id")
                AuthService.findUserByID(donor) { findSuccess ->
