...
class SharedPrefs(context: Context) {
    ...
    val RATING= 1.0
    val CLOTH_DONATED= 0
    val HIDE_EMAIL="hideEmail"
    val HIDE_PHONE="hidePhone"
    val IS_ADMIN="isAdmin"

    var hideUserEmail: String
        get() = prefs.getString(HIDE_EMAIL, "")!!
        set(value) = prefs.edit().putString(HIDE_EMAIL, value).apply()

    var hideUserPhone: String
        get() = prefs.getString(HIDE_PHONE, "")!!
        set(value) = prefs.edit().putString(HIDE_PHONE, value).apply()

    var isAdmin: String
        get() = prefs.getString(IS_ADMIN, "")!!
        set(value) = prefs.edit().putString(IS_ADMIN, value).apply()
